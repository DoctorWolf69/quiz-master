function ChallengeCard() {
  return (
    <div className="md:col-span-4 bg-gradient-to-br from-primary-container to-inverse-primary relative overflow-hidden rounded-3xl p-gutter flex flex-col justify-between text-on-primary shadow-2xl border border-white/10 group">
      ...
      <button className="relative z-10 w-full py-4 bg-on-surface text-background rounded-xl font-bold active:scale-95 transition-all duration-200 hover:shadow-xl">
        Jump In Now
      </button>
    </div>
  );
